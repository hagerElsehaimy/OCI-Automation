...
for OCID in OCIDs:
    ...
    if re.search("dbnode", OCID):
        ...
        # doc for more info
        db_node_action_response = database_client.db_node_action(db_node_id=OCID, action="STOP")
    elif re.search("instance", OCID):
        core_client = oci.core.ComputeClient(config)
        instance_action_response = core_client.instance_action(instance_id=OCID, action="SOFTSTOP")
